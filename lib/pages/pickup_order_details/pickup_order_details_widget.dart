...
class _PickupOrderDetailsWidgetState extends State<PickupOrderDetailsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PickupOrderDetailsModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OrdersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersRecord> pickupOrderDetailsOrdersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final pickupOrderDetailsOrdersRecord =
            pickupOrderDetailsOrdersRecordList.isNotEmpty
                ? pickupOrderDetailsOrdersRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: const Color(0xFFF5F5F5),
